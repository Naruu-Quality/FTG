...
if(_curTarget isKindOf "House_F" && {player distance _curTarget < 12} OR ((nearestObject [[23751.881,16250,0],"Land_Dome_Big_F"]) == _curTarget OR (nearestObject [[23752.334,16249.799,0],"Land_Dome_Small_F"]) == _curTarget)) exitWith {
