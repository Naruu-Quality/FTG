...
_serverInfoString = format ["<t color='#FFFFFF'>FTG Altis life V4.4</t>"];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://frenchteamgaming.com/'>FTG</a></t> Forums: <t color='#0091CD'><a href='http://forum.frenchteamgaming.com/index.php'>FTG Forum</a></t> TeamSpeak: frenchteamgaming.fr";
