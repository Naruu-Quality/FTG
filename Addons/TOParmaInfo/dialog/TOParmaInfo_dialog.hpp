...
class TOParmaInfoD
{
	...
	{	
		...
		{
			idc = 10032;
			text = "FTG Information";
			colorBackground[] = {0.82,0.231,0.231,0.8};
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
			y = "0 * ((((safezoneW / safezoneH) min 1.2) / 1.2) / 25)";
			w = "30 * (((safezoneW / safezoneH) min 1.2) / 40)";
		...
		class TAGeneralInfoBackground: RscText
		{
			...
			type = CT_STRUCTURED_TEXT;
			size = 0.030;
			text = "Website: frenchteamgaming.com Forums: forum.frenchteamgaming.com TeamSpeak: frenchteamgaming.fr";
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
		...
		class TAInfoCloseButton: w_RscButton
		{
			...
			text = "Appuyer sur échap pour fermer";
			sizeEx = 0.04;
